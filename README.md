...
enter. The garden takes about forty seconds to grow it — the water fills with
light while you wait. Each visitor may grow one new flower a day; a flower
someone has already grown appears instantly.

Every flower is grown in its own weather — fog, aurora, gold, mirror, frost,
smoke… — chosen by the flower's name. The same name always returns to the
same weather.
